...
public static class CustomerContextSeed
{
    public static IHost SeedCustomerData(this IHost host)
    {
        ...
        CreateCustomer(customerContext, "customer1", "customer1", "customer2", "customer1@gmail.com").GetAwaiter().GetResult();
        CreateCustomer(customerContext, "customer2", "customer2", "customer2", "customer21@gmail.com").GetAwaiter().GetResult();
